...
4. **Run the Docker container:**
   ...
   ```
The service will be accessible on port localhost:8080.
...
```
*Note: replace {id} field with the actual id generated by post request*
* The ideal output format will be:
```
{
    "flag": true,
...
```
curl http://localhost:8080/receipts/8888888888888/points
```
* The output format will be:
```
{
...
![Schreenshot of H2-database Table Detail](images/h2-database-detail.png)
